...
% optimisation
%
%   z_guess=assign_z0(nx,nu,N,h,x_in,u_guess,f)
%
% Inputs:
...
%   x_in: initial condition on the state | (nx,1) vector
%   u_guess: initial guess for the control history | (N,nu) vector
%   f: equation of motion | function handle
%
% Output:
