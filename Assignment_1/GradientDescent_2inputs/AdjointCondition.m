...
df2dx3 = rho*S/2*Cd*x(2)^2/(x(3))^2-u(1)*cos(u(2))/x(3)^2;
df2dx4 = -g*cos(x(4));
df3dx1 = 0;
df3dx2 = 0;
df3dx3 = 0;
df3dx4 = 0;
df4dx1 = 0;
df4dx2 = rho*S/2*Cl/x(3)+g*cos(x(4))/x(2)^2-u(1)*sin(u(2))/x(3)/x(2)^2;
df4dx3 = -rho*S/2*Cl*x(2)/x(3)^2-u(1)*sin(u(2))/x(3)^2/x(2);
